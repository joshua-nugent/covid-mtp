...
expo <- "all_day_bing_tiles_visited_relative_change"
the_date <- "tvcovar_2021_10_23"
outcome_lead <- "2wks"
...
for(i in 1){
  ...
  CASES <- analysis_wrapper(covars = c(finalset,"new_cases_1wks_behind_percap"),
                          ...
                          weeks = weeksC[i],
                          pop_cutoff = 0,
                          shifts = shifts, shift_type = "add",
                          shift_lower_bound = -1, shift_upper_bound = 1.2,
