...
expo <- "workplaces_percent_change_from_baseline"
the_date <- "2021_02_19"
outcome_lead <- "2wks"
...
case_covars <- case_covars[case_covars %nin% excludable_case_covars_GW]
...
CASES <- analysis_wrapper(covars = case_covars,
                          ...
                          weeks = weeksC,
                          pop_cutoff = 0, 
                          shifts = c(-4, -3, -2), shift_type = "add",
                          shift_lower_bound = -100, shift_upper_bound = 100,
